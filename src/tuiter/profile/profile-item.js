...
const ProfileItem = () => {
    ...
    return (
        ...
        <div className="row">
            <div className="col-10 col-lg-8 col-xl-12 border rounded px-0 pt-3">
                <div className="row px-3">
                    ...
                    <div className="col-11">
                        ...
                        <div className="text-secondary small">{profile.noOfTweets} Tweets</div>
                    </div>
                </div>
                <div>
                    <div className="position-relative">
                        <img src={`/images/${profile.bannerPicture}`} alt="banner" className="w-100 px-0 mx-0 border-0"></img>
                        <img src={`/images/${profile.profilePicture}`} alt="avatar" className="h-50 rounded-circle card-img-overlay ms-3 mt-5 top-50"></img>
                    </div>
